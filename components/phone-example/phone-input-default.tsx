...
export function PhoneInputDefault({
  ...
  const phoneDataString = JSON.stringify(phoneData, null, 2);
      ...
      {hiddenDetails ? null : (
        <>
          <p className="text-muted-foreground">
            We can use the <Code>getPhoneData</Code> utility function to get a
            lot of information about the selected number.
          </p>
